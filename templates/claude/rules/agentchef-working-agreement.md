# Global Claude Code Working Agreements
...
- Prefer repo-local `CLAUDE.md`, scripts, package managers, helpers, and naming conventions.
...
- Use the current prompt for one-off constraints and `CLAUDE.md` for durable working agreements.
...
- Prefer official Anthropic docs for Claude Code behavior and official project docs or Context7 for version-sensitive APIs.
