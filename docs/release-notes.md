...
Codex Chef 0.5.72 established the standalone maintenance release line with
the reviewed independent installation, preview, backup, repair, and runtime
verification flows that 0.5.73 retains.
