...
| Plugin distribution | Local `agentchef-workflows` plugin with one exact, trust-gated SessionEnd process hook. | Context-injecting hooks, broad MCP, or external auth. |
